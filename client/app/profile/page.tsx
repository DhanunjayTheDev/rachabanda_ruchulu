                    ...
                    <div className="card space-y-4">
                      ...
                      <div>
                        ...
                        <LocationMapPicker
                          ...
                          onChange={(lat, lng) => setAddrForm((prev) => ({ ...prev, latitude: lat, longitude: lng }))}
                        />
                      </div>
                        ...
                        return (
                          <div key={id} className="card">
                            ...
                            <div className="flex gap-3 flex-wrap">
                              ...
                              {!addr.isDefault && (
                                <button onClick={() => handleSetDefault(id)} className="px-4 py-2 rounded-lg border border-gray-600 text-gray-400 hover:border-primary-gold/30 hover:text-primary-gold font-semibold text-sm transition">Set as Default</button>
                              )}
                              <button onClick={() => handleDeleteAddress(id)} className="px-4 py-2 rounded-lg border border-red-600/30 text-red-400 hover:bg-red-600/10 font-semibold text-sm transition">Delete</button>
                            </div>
                          </div>
                        );
                      })}
