            ...
            <div className="card">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-sm text-primary-gold hover:text-primary-accent-gold">Forgot password?</Link>
                </div>
              ...
              <p className="text-center mt-8 text-gray-400">
                ...
                <Link to="/signup" className="text-primary-gold hover:text-primary-accent-gold font-semibold">Sign up here</Link>
              </p>
            </div>
          </div>
        </div>
