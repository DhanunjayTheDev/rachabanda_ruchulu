    ...
    return (
      <main className="min-h-screen pt-28 pb-20 px-6">
        <div className="max-w-7xl mx-auto card text-center py-20">
          ...
          <Link to="/cart"><button className="btn btn-outline mt-3">Back to Cart</button></Link>
        </div>
        <LoginDialog
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {(showNewAddressForm || addresses.length === 0) && (
                  <div className="space-y-4 pt-4 border-t border-gray-700">
                    ...
                    <div>
                      ...
                      <Suspense fallback={<div className="w-full h-64 bg-dark-input rounded-xl animate-pulse" />}>
                        <LocationMapPicker
          ...
          <div className="card sticky top-28 h-fit space-y-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link to="/cart"><button className="w-full btn btn-outline">Back to Cart</button></Link>
            </div>
          </div>
        </div>
      </div>
