          ...
          <div className="lg:col-span-1">
            <div className="card sticky top-28">
              ...
              <div className="mb-6">
                ...
                <div className="flex overflow-x-auto md:block space-x-2 md:space-x-0 md:space-y-2 pb-2 md:pb-0 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                  <button
                    onClick={() => setSelectedCategory('all')}
                    className={`shrink-0 whitespace-nowrap block md:w-full text-left px-4 py-2 rounded-lg transition-all ${selectedCategory === 'all'
                        ? 'bg-primary-gold text-dark-bg font-bold'
                        : 'bg-dark-card md:bg-transparent text-gray-300 hover:text-primary-gold'
                      }`}
                  >
                    All Items
                  </button>
                  {categories.map((cat) => (
                    <button
                      ...
                      className={`shrink-0 whitespace-nowrap block md:w-full text-left px-4 py-2 rounded-lg transition-all ${selectedCategory === cat._id
                          ? 'bg-primary-gold text-dark-bg font-bold'
                          : 'bg-dark-card md:bg-transparent text-gray-300 hover:text-primary-gold'
                        }`}
                    >
