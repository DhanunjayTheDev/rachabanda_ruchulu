  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-dark-bg flex items-center justify-center">
      <div className="absolute inset-0 overflow-hidden">
        <motion.div className="absolute w-96 h-96 bg-primary-gold/10 rounded-full blur-3xl" animate={{ x: [0, 100, 0], y: [0, 50, 0] }} transition={{ duration: 20, repeat: Infinity }} style={{ top: '10%', left: '10%' }} />
        <motion.div className="absolute w-80 h-80 bg-primary-gold/5 rounded-full blur-3xl" animate={{ x: [0, -100, 0], y: [0, -50, 0] }} transition={{ duration: 25, repeat: Infinity }} style={{ bottom: '10%', right: '10%' }} />
      </div>
      ...
      <div ref={containerRef} className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8">
          ...
          <motion.h1 variants={itemVariants} className="text-6xl md:text-7xl font-bold text-white leading-tight">
            Authentic Village Flavors<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-gold to-primary-accent-gold">Delivered Fresh</span>
          </motion.h1>
