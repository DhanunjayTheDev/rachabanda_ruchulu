      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            ...
            <div className="flex gap-4">
              <a href="#" className="text-primary-gold hover:text-primary-accent-gold transition-colors">f</a>
              <a href="#" className="text-primary-gold hover:text-primary-accent-gold transition-colors">Instagram</a>
              <a href="#" className="text-primary-gold hover:text-primary-accent-gold transition-colors">Twitter</a>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.1 }}>
            ...
            <ul className="space-y-2">
              <li><Link to="/menu" className="text-gray-400 hover:text-primary-gold transition-colors">Menu</Link></li>
              <li><Link to="/about" className="text-gray-400 hover:text-primary-gold transition-colors">About Us</Link></li>
              <li><Link to="/contact" className="text-gray-400 hover:text-primary-gold transition-colors">Contact</Link></li>
              <li><Link to="/orders" className="text-gray-400 hover:text-primary-gold transition-colors">My Orders</Link></li>
            </ul>
          </motion.div>
        ...
        <div className="border-t border-primary-gold/20 pt-8 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <Link to="/privacy" className="text-gray-400 hover:text-primary-gold text-sm transition-colors">Privacy Policy</Link>
            <Link to="/terms" className="text-gray-400 hover:text-primary-gold text-sm transition-colors">Terms & Conditions</Link>
          </div>
        </div>
      </div>
    </footer>
